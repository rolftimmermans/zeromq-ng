...
class Socket extends EventEmitter {
  ...
  setsockopt(option: number | keyof typeof shortOptions, value: any) {
    ...
    case longOptions.ZMQ_AFFINITY:
      this._socket.affinity = value; break
    case longOptions.ZMQ_IDENTITY:
      (this._socket as zmq.Router).routingId = value; break
    case longOptions.ZMQ_SUBSCRIBE:
      (this._socket as zmq.Subscriber).subscribe(value); break
    case longOptions.ZMQ_UNSUBSCRIBE:
      (this._socket as zmq.Subscriber).unsubscribe(value); break
    case longOptions.ZMQ_RATE:
      this._socket.rate = value; break
    ...
    case longOptions.ZMQ_RECONNECT_IVL:
      this._socket.reconnectInterval = value; break
    case longOptions.ZMQ_BACKLOG:
      this._socket.backlog = value; break
    case longOptions.ZMQ_RECOVERY_IVL_MSEC:
      this._socket.recoveryInterval = value; break
    case longOptions.ZMQ_RECONNECT_IVL_MAX:
      this._socket.reconnectMaxInterval = value; break
    ...
    case longOptions.ZMQ_ROUTER_MANDATORY:
      (this._socket as zmq.Router).mandatory = !!value; break
    case longOptions.ZMQ_TCP_KEEPALIVE:
      this._socket.tcpKeepalive = value; break
    case longOptions.ZMQ_TCP_KEEPALIVE_CNT:
      this._socket.tcpKeepaliveCount = value; break
    case longOptions.ZMQ_TCP_KEEPALIVE_IDLE:
      this._socket.tcpKeepaliveIdle = value; break
    case longOptions.ZMQ_TCP_KEEPALIVE_INTVL:
      this._socket.tcpKeepaliveInterval = value; break
    case longOptions.ZMQ_TCP_ACCEPT_FILTER:
      this._socket.tcpAcceptFilter = value; break
    ...
    case longOptions.ZMQ_PLAIN_SERVER:
      this._socket.plainServer = !!value; break
    case longOptions.ZMQ_PLAIN_USERNAME:
      this._socket.plainUsername = value; break
    case longOptions.ZMQ_PLAIN_PASSWORD:
      this._socket.plainPassword = value; break
    case longOptions.ZMQ_CURVE_SERVER:
      this._socket.curveServer = !!value; break
    case longOptions.ZMQ_CURVE_PUBLICKEY:
      this._socket.curvePublicKey = value; break
    case longOptions.ZMQ_CURVE_SECRETKEY:
      this._socket.curveSecretKey = value; break
    case longOptions.ZMQ_CURVE_SERVERKEY:
      this._socket.curveServerKey = value; break
    case longOptions.ZMQ_ZAP_DOMAIN:
      this._socket.zapDomain = value; break
    case longOptions.ZMQ_HEARTBEAT_IVL:
      this._socket.heartbeatInterval = value; break
    case longOptions.ZMQ_HEARTBEAT_TTL:
      this._socket.heartbeatTimeToLive = value; break
    case longOptions.ZMQ_HEARTBEAT_TIMEOUT:
      this._socket.heartbeatTimeout = value; break
    case longOptions.ZMQ_CONNECT_TIMEOUT:
      this._socket.connectTimeout = value; break
    case longOptions.ZMQ_ROUTER_HANDOVER:
      (this._socket as zmq.Router).handover = !!value; break
    default:
