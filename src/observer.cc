...
namespace zmq {
    ...
    Observer::Observer(const Napi::CallbackInfo& info)
      : Napi::ObjectWrap<Observer>(info) {
        ...
        auto address = std::string("inproc://zmq.monitor.") + std::to_string(reinterpret_cast<uintptr_t>(this));
        ...
        poller.SetReadableValidate(std::bind(&Observer::HasEvents, this));
    }
    ...
    void Observer::Initialize(Napi::Env& env, Napi::Object& exports) {
        auto constructor = DefineClass(env, "Observer", {
